...
stringArt( ...
    'inputFilePath', 'input/dog.png', ... % path to the input file
    'outputDirPath', 'output/dog', ... % path to the output directory
    'outputFileNamePrefix', 'dog', ... % prefix of the output files
